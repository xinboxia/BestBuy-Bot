...
class BBYbot():
	...
	def add_toCart(self, incart):
		try:
			time.sleep(3)
			add_to_cart_button = self.driver.find_element_by_class_name("add-to-cart-button")
			add_to_cart_button.click()
			#item =self.driver.find_element_by_class_name('btn-primary btn-lg')
			#item.click()
			time.sleep(3)							
	...
	def checkout(self):
		time.sleep(3)
		#selects shipping
		self.driver.find_element_by_xpath('/html/body/div[1]/main/div/div[2]/div[1]/div/div/span/div/div[2]/div[1]/section[1]/div[4]/ul/li/section/div[2]/div[2]/form/div[2]/fieldset/div[2]/div[1]/div/div/div/input').click()
		#presses checkout
		self.driver.find_element_by_xpath('/html/body/div[1]/main/div/div[2]/div[1]/div/div/span/div/div[2]/div[1]/section[2]/div/div/div[3]/div/div[1]/button').click()
		#continues to payment
		time.sleep(2)
		self.driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/div[2]/div[1]/div[1]/main/div[2]/div[2]/form/section/div/div[2]/div/div/button').click()
		time.sleep(4)
		paymentinfo=self.driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/div[2]/div[1]/div[1]/main/div[2]/div[3]/div/section/div[1]/div/section/div[1]/div/input')
		...
		securitycode=self.driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/div[2]/div[1]/div[1]/main/div[2]/div[3]/div/section/div[1]/div/section/div[2]/div[2]/div/div[2]/div/input')
		securitycode.send_keys(self.cardsecurity)
		self.driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/div[2]/div[1]/div[1]/main/div[2]/div[3]/div/section/div[4]/button').click()
